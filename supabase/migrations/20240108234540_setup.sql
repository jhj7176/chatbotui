...
AS $$
DECLARE
  project_url TEXT := 'https://qnvywxcjjpidqukriany.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InFudnl3eGNqanBpZHF1a3JpYW55Iiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTcwNTM2NDkzOCwiZXhwIjoyMDIwOTQwOTM4fQ.auryDOtntNGRJUPOFR769Q0bYG51Yhw0diy_l71hgtc'; -- full access needed for http request to storage
